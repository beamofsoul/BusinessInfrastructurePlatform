...
@Aspect
@Component
public class MiserlyAspect {

	public static final Logger LOGGER = LoggerFactory.getLogger(MiserlyAspect.class);
	...
	@Pointcut(value="@annotation(miserly)")
	public void locateAnnotation(Miserly miserly) {}
	
	@Before("locateAnnotation(miserly)")
	public void doBefore(JoinPoint joinPoint, Miserly miserly) {}
	
	@Around("locateAnnotation(miserly)")
	public Object doAround(ProceedingJoinPoint joinPoint, Miserly miserly) {
		Class<?> clazz = miserly.value();
